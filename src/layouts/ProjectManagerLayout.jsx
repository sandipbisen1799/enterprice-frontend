      ...
      <div className="pt-16 flex">
        ...
        >
          <nav className="flex flex-col mt-5 ">
            <div className={  itemClass("/projectManager")} onClick={() => navigate("/projectManager")}>
